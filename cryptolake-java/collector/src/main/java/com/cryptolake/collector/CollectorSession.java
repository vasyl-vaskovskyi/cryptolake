 ...
 * format matches Python's {@code f"{collector_id}_{time.strftime('%Y-%m-%dT%H:%M:%SZ', time.gmtime())}"}
 * — fractional seconds are intentionally omitted to avoid PK collision issues in PG.
 *
