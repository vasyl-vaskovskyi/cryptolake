 ...
 *
 * <p>Ports Python's {@code FileState} (design §6.5). PG table: {@code writer_file_state(topic,
 * partition, file_path, high_water_offset, file_byte_size, updated_at)} with composite PK {@code
 * (topic, partition, file_path)}.
 *
